...
Vellune 1.0.0 已在 iPadOS 27 beta 3 上通过 schema 7 回归测试：

| 检查项 | 结果 |
| --- | ---: |
| 应用容器 | 发现 296 个，识别 296 个 |
| App Group 容器 | 索引 200 个 |
| 插件容器 | 索引 1,050 个 |
| 内部守护进程容器 | 索引 17 个 |
| 系统数据容器 | 索引 21 个 |
| 系统组容器 | 索引 28 个 |
| MobileGestalt 读取、plist 预览、安全导出 | 通过 |

具体数量因设备而异。报告会写入 Vellune 自身数据容器内的
